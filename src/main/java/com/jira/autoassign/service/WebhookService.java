...
/**
 * Posts raw JSON to a Power Automate HTTP-trigger webhook.
 * PA Compose builds the Adaptive Card from this payload.
 *
 * Payload shape (ONE call per scheduler cycle):
 * {
 ...
 *     {
 *       "key":             "SAC-123",
 *       "summary":         "Full ticket summary — never truncated",
 *       "slaRemaining":    "2h 5m remaining",   // or "⚠ Breached" or ""
 *       "currentAssignee": "john.doe@company.com",
 *       "reassignedTo":    "alice@company.com",
